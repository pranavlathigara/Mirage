...
import com.jorgecastilloprz.mirage.di.modules.AnimationModule;
...
@PerActivity @Component(dependencies = ApplicationComponent.class, modules = {
    ActivityModule.class, AnimationModule.class
}) public interface MapActivityComponent extends AbstractActivityComponent {
